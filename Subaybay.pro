...
UBUNTU_TRANSLATION_DOMAIN="subaybay.kugiigi"
...
aptest.commands = bash $$PWD/subaybay/tests/autopilot/run
aptest.depends  = sub-subaybay

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/subaybay/tests/unit
unittest.depends  = sub-subaybay
